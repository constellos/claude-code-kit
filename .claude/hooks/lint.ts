 ...
 * on the modified file, providing immediate feedback about type errors.
 *
 * @module hooks/lint
 */

import type { PostToolUseInput, PostToolUseHookOutput } from 'claude-code-kit-ts';
import { createDebugLogger } from 'claude-code-kit-ts';
...
export default async function (
  ...
  try {
    ...
    return {
      systemMessage: `Type checking failed: ${error.message}`,
    };
  }
}
